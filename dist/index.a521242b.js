...
var _patternomaly = require("patternomaly");
(async function() {
    var myChart = new (0, _auto.Chart)(document.getElementById("acquisitions").getContext("2d"), {
        type: "bar",
        data: {
            labels: [
                "jabuke",
            ...
            datasets: [
                {
                    ...
                    backgroundColor: [
                        pattern.draw("square", "rgb(206, 70, 10, 1)"),
                        pattern.draw("circle", "rgb(206, 70, 10, 1)"),
                        pattern.draw("diamond", "rgb(206, 70, 10, 1)"),
                        pattern.draw("triangle", "rgb(206, 70, 10, 1)")
                    ],
                    /*
...
},{"chart.js/auto":"d8NN9","chart.js":"ipU8D","patternomaly":"lrNK2"}],"d8NN9":[function(require,module,exports) {
...
},{}],"lrNK2":[function(require,module,exports) {
(function(global, factory) {
    ...
    function generate(colorList) {
        ...
        return colorList.map(function(color, index, list) {
            ...
            } else if (index === list.length - 1) shapeType = getRandomShape([
                previousShapeType,
                firstShapeType
            ]);
            else {
